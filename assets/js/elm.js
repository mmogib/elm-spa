...
var $author$project$Main$handleUrlChange = function (url) {
	return $author$project$Main$Redirect(url);
};
var $author$project$Main$LoadExternalUrl = function (a) {
	return {$: 'LoadExternalUrl', a: a};
};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$PushUrlToNav = function (a) {
	return {$: 'PushUrlToNav', a: a};
};
...
var $author$project$Main$handleUrlRequest = function (request) {
	if (request.$ === 'Internal') {
		var url = request.a;
		...
		if (_v1.$ === 'Nothing') {
			...
			return $author$project$Main$PushUrlToNav(
				$elm$url$Url$toString(url));
		}
	} else {
		var href = request.a;
		return $author$project$Main$LoadExternalUrl(href);
	}
};
...
var $author$project$Page$About$Title = function (a) {
	return {$: 'Title', a: a};
};
var $author$project$Page$About$toTitle = function (str) {
	return $author$project$Page$About$Title(str);
};
var $author$project$Page$About$init = function (str) {
	return _Utils_Tuple2(
		$author$project$Page$About$toTitle(str),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Page$Home$Model = F2(
	function (counter, message) {
		return {counter: counter, message: message};
	});
var $author$project$Page$Home$init = _Utils_Tuple2(
	A2($author$project$Page$Home$Model, 1, 'Home Page'),
	$elm$core$Platform$Cmd$none);
...
var $author$project$Main$changeRouteTo = F2(
	function (url, key) {
		...
		if (mayberoute.$ === 'Nothing') {
			return _Utils_Tuple2(
				{key: key, page: $author$project$Page$NotFound},
				$elm$core$Platform$Cmd$none);
		} else {
			...
			switch (route.$) {
				case 'NotFoundRoute':
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'About':
					var _v2 = $author$project$Page$About$init('This is About page');
					var aboutModel = _v2.a;
					var aboutCmds = _v2.b;
					return _Utils_Tuple2(
						{
							key: key,
							page: $author$project$Page$About(aboutModel)
						},
						A2($elm$core$Platform$Cmd$map, $author$project$Main$GotAboutMsg, aboutCmds));
				default:
					...
					var cmds = $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($elm$core$Platform$Cmd$map, $author$project$Main$GotHomeMsg, homecmds)
							]));
					var model = {
						key: key,
						page: $author$project$Page$Home(homemodel)
					};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A2($author$project$Main$changeRouteTo, url, key);
	});
...
var $author$project$Page$About$TitleChangedRandomly = function (a) {
	return {$: 'TitleChangedRandomly', a: a};
};
...
var $author$project$Page$About$update = F2(
	function (msg, _v0) {
		if (msg.$ === 'TitleChanged') {
			...
			var cmds = A2(
				$elm$random$Random$generate,
				$author$project$Page$About$TitleChangedRandomly,
				A2($elm$random$Random$int, -8, 9));
			return _Utils_Tuple2(
				$author$project$Page$About$toTitle(str),
				cmds);
		} else {
			var _int = msg.a;
			return _Utils_Tuple2(
				$author$project$Page$About$toTitle(
					'Random Title #' + $elm$core$String$fromInt(_int)),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Page$Home$SetMessage = function (a) {
		...
		if (msg.$ === 'SetMessage') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{message: message}),
				$author$project$Api$storeCache(
					$elm$core$Maybe$Just(
						$elm$json$Json$Encode$string(message))));
		} else {
			var amount = msg.a;
			var task = $elm$core$Task$succeed('Changing counter');
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{counter: model.counter + amount, message: '...'}),
				A2($elm$core$Task$perform, $author$project$Page$Home$SetMessage, task));
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Redirect':
				var url = msg.a;
				return A2($author$project$Main$changeRouteTo, url, model.key);
			case 'GotAboutMsg':
				var submsg = msg.a;
				var oldsubmodl = function () {
					var _v2 = model.page;
					if (_v2.$ === 'About') {
						var mdl = _v2.a;
						return mdl;
					} else {
						return $author$project$Page$About$init('New Title').a;
					}
				}();
				var _v1 = A2($author$project$Page$About$update, submsg, oldsubmodl);
				var submodel = _v1.a;
				var subcommands = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Page$About(submodel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$GotAboutMsg, subcommands));
			case 'GotHomeMsg':
				var submsg = msg.a;
				var oldsubmodl = function () {
					var _v4 = model.page;
					if (_v4.$ === 'Home') {
						...
						return $author$project$Page$Home$init.a;
					}
				}();
				var _v3 = A2($author$project$Page$Home$update, submsg, oldsubmodl);
				var submodel = _v3.a;
				var subcommands = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Page$Home(submodel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$GotHomeMsg, subcommands));
			default:
...
var $author$project$View$dataProp = F2(
	function (name, value) {
		return A2($elm$html$Html$Attributes$attribute, 'data-' + name, value);
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					A2($author$project$View$dataProp, 'toggle', 'collapse'),
					A2($author$project$View$dataProp, 'target', '#navbarToggler')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Asset$imageToString = function (_v0) {
	var url = _v0.a;
	return url;
};
...
var $author$project$NotFound$notFoundImg = $author$project$Asset$error;
...
var $author$project$NotFound$view = A2(
	...
	_Utils_ap($Orasund$elm_ui_framework$Framework$Card$fill, _List_Nil),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					A2($mdgriffith$elm_ui$Element$paddingXY, 25, 20)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Counter = ' + 'Oops.')
						])),
					A2(
					...
					_List_Nil,
					{
						...
						src: $author$project$Asset$imageToString($author$project$NotFound$notFoundImg)
					})
				]))
		]));
...
var $author$project$Page$About$title = function (_v0) {
	var str = _v0.a;
	return str;
};
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(
					$author$project$Page$About$title(model))),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_Utils_ap(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Counter = ' + 'String.fromInt model.counter')
							]))
					]))
			]));
};
var $author$project$Page$Home$IncreaseBy = function (a) {
	return {$: 'IncreaseBy', a: a};
};
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									...
									_Utils_ap(
										$Orasund$elm_ui_framework$Framework$Color$success,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
											]))),
								{
									...
									onPress: $elm$core$Maybe$Just(
										$author$project$Page$Home$IncreaseBy(5))
								})
							]))
					]))
			]));
...
var $author$project$Main$view = function (model) {
	return {
		body: $author$project$Main$mainView(model),
		title: 'Site in Elm'
	};
};
